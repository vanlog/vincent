...
golem::fill_desc(
  ...
  pkg_title = "Shiny Ready App", # The Title of the package containing the App 
  pkg_description = "This is a Maintainable Shiny Application.", # The Description of the package containing the App 
  ...
  repo_url = "https://github.com/vanlog/vincent" # NULL # The URL of the GitHub Repo (optional) 
)     
