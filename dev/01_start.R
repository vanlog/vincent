...
golem::fill_desc(
  ...
  pkg_title = "Tidy App", # The Title of the package containing the App 
  pkg_description = "This is a tidy application.", # The Description of the package containing the App 
